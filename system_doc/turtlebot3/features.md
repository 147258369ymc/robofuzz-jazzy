...
![Features with Icons](https://emanual.robotis.com/assets/images/platform/turtlebot3/features/features_with_icons.png)
...
- The TurtleBot brand is managed by [Open Robotics](https://www.openrobotics.org/), which develops and maintains ROS. Nowadays, ROS has become the go-to platform for roboticists around the world. The TurtleBot family can be integrated with existing ROS-based robot components, but TurtleBot3 is designed to be an affordable base platform for those who want to get started learning ROS.

**Extensibility**

- TurtleBot3 encourages users to customize its mechanical structure with some alternative options: The platform consists of an open source embedded board (as a motor control board), a single board computer as the main compute unit, and lidar or visual sensors placed on a two-wheeled differential drive platform. Beyond this the TurtleBot3 platform is able to be structurally and mechanically customized in many ways: Cars, Bikes, Trailers and so on. Extend your ideas beyond imagination with various SBC, sensors and motors on a scalable structure.
...
![TurtleBot3 Burger Dimension](https://emanual.robotis.com/assets/images/platform/turtlebot3/hardware_setup/turtlebot3_dimension1.png)

#### Data of TurtleBot3 Waffle Pi

![TurtleBot3 Waffle Pi Dimension](https://emanual.robotis.com/assets/images/platform/turtlebot3/hardware_setup/turtlebot3_dimension3.png)

## Components

![TurtleBot3 Burger Components](https://emanual.robotis.com/assets/images/platform/turtlebot3/hardware_setup/turtlebot3_burger_components.png)

![TurtleBot3 Waffle Pi Components](https://emanual.robotis.com/assets/images/platform/turtlebot3/hardware_setup/turtlebot3_waffle_pi_components.png)
...
| Category | Part Name | Burger | Waffle Pi |
|----------|-----------|-------:|----------:|
...
*Source: [ROBOTIS e-Manual - TurtleBot3 Features](https://emanual.robotis.com/docs/en/platform/turtlebot3/features/)*
